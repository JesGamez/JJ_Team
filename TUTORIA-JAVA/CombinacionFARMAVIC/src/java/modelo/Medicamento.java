...
public class Medicamento {
    ...
    private int IDMED,STOCMED,IDPROV;
    private String PRESMED, GENMED, COMMED,FORMED,LOTMED,ESTMED;
    ...
    public Medicamento(int IDMED, int STOCMED, int IDPROV, String PRESMED, String GENMED, String COMMED, String FORMED, String LOTMED, String ESTMED, Double PRECMED, Date FVMED) {
        this.IDMED = IDMED;
